        ...
        <div className='mt-40 container mx-auto'>
            ...
            <div className="md:flex justify-center items-center">
                ...
                <div className="flex-1 px-7 mt-14 md:mt-0">
                    ...
                    <p>এটি একটি স্বতন্ত্র ওয়েবসাইট, যা বানানো হয়েছে কেবলমাত্র ছাত্রদের যোগাযোগ রক্ষা করার সুবিধার্থে। ওয়েবসাইটের সাথে কোন সার্ভার সংযুক্ত না থাকায় ওয়েবসাইটটি দ্বারা কোন ধরনের আর্থিক লেনদেন করা সম্ভব নয়। এটি একটি ব্যক্তিগত ওয়েবসাইট যা ব্যবহার করা হবে একান্ত ব্যক্তিগতভাবে, কোন ধরনের সাধারণ ব্যবহারকারীদের জন্য এটি প্রযোজ্য নয় ওয়েব সাইটটি সম্পূর্ণ নির্মাণ এবং এর রক্ষণাবেক্ষণের জন্য দায়িত্ব পালন করেছেন <Link className='text-yellow-300' to={'http://hmhasibul.netlify.app'}>হাসিবুল ইসলাম</Link>।আপনার সুস্থতা কামনা করে সমাপ্ত করছি -- ধন্যবাদ</p>
                </div>
