        ...
        <div className='mt-10 container mx-auto'>
            ...
            <div className="md:flex justify-center items-center">
                <div className="flex-1 px-7">
                    <p className='font-extralight tracking-widest md:text-start'>This project is designed to keep our class connected by organizing and sharing each student's data in a fun and interactive way.The project is fully made by <Link className='text-yellow-300' to={"http://hmhasibul.vercel.app"}>Hasibul Islam</Link>. It’s all about building a sense of community, helping us stay in touch, and getting to know each other better. This project is just for us, making it easier to stay connected togather!</p>
                </div>
