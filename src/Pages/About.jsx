            ...
            <div className='shadow-lg shadow-gray-700 border-themeColor border rounded-2xl mt-20 md:mt-28  container mx-auto py-4 flex flex-col gap-5'>
                ...
                <div className="px-7">
                    ...
                    <div className="textSection text-center mt-10">
                        ...
                        <p className='md:text-xl text-center flex flex-col gap-5 mt-12'>

                            ---
                            "একসঙ্গে চলার যে পথ, সে পথের শেষ নেই, <br />
                            চলে গেলেও সময়, স্মৃতিগুলো ফুরায় না এই।<br />
                            হাসি-কান্নার অজস্র গাঁথা, আড়ালে রয়ে যায়,<br />
                            মনে হয়, বন্ধুত্বের সেই সুবাস আজও ভেসে বেড়ায়।"<br />
                            <br />
                            "বিদায়ের দিন, চোখে জল, তবু মিষ্টি এক হাসি,<br />
                            একসাথে কেটেছে কত মুহূর্ত, ছিল আনন্দে ভরপুর ভালোবাসি।<br />
                            প্রতিটি দিন একেকটি গল্প, লিখেছে হৃদয়ের পাতায়,<br />
                            যেন বৃষ্টি শেষে রোদ্দুরে ফুটে থাকা স্মৃতির ছায়া।"<br />
                            <br />
                            "যে মুহূর্তগুলো একসঙ্গে কেটেছে, তা আর ফিরবে না,<br />
                            তবু মনে হবে, সেই হাসির রেশ যেন মলিন হয় না।<br />
                            বিস্মৃতির আড়ালেও সেগুলো থাকে উজ্জ্বল আলোয়,<br />
                            যেন দূর আকাশের তারা, চিরদিন থেকে যায় স্নিগ্ধতায়।"<br />
                            <br />
                            "জীবন ভরবে নতুন পথে, নতুন মানুষ, নতুন গল্পে,<br />
                            কিন্তু এই স্মৃতিগুলো হবে পথের আলোর দিশারি রূপে।<br />
                            ক্লাসরুমের দেয়ালে বাঁধা সেই হাসি, সেই কান্নার সুর,<br />
                            রয়ে যাবে মনের গহীনে, চিরকাল অমলিন, চির ভাস্বর।"
                            ---
                        </p>
                    </div>
                    <div className="textSection text-center mt-10">
